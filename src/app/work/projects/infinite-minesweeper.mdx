...
summary: "A Unity-based reimagining of Minesweeper with an infinite, procedurally generated grid, roguelike mechanics, and an event-driven architecture."
images:
...
It’s a new take on the classic Minesweeper:

- The grid is **infinite—** it keeps growing as you explore.
- The game is **roguelike—** you have limited flags and must mark a set number of mines to win.
- The goal is simple: **complete as many qoutas as possible.**
## Current Features

### 🔹 Infinite Grid System
- The grid dynamically adjusts to the player’s viewport.
